...
export default function Maintance() {
  ...
  return (
    <div
      className={`w-full ${
        isMobile ? "h-[90dvh]" : "h-[80dvh]"
      } grid gap-8 px-8 place-items-center`}
    >
      {isMobile && (
      ...
      <div className="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0">
        ...
        <p>
          {isMobile
            ? '"While our mobile-friendly version is in the works", you can access the full features of our website using your desktop or laptop.'
            : null}
        </p>
      </div>
      <div className="w-full py-4 border-t border-gray-300">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center text-gray-600 text-sm md:space-x-8 space-y-1 md:space-y-0">
          ...
          >
            ...
            <span>07 000 222 555</span>
          </Link>
          <Link
            href="mailto: info@rashakagro.com"
            className="flex items-center space-x-1"
            target="_blank"
            title="Email"
          >
