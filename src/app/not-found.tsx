...
export default async function NotFound() {
  return (
    <main className="px-4 py-4 sm:py-8 lg:px-8 flex flex-col h-[100dvh] items-center mx-auto bg-gray-50 max-w-6xl w-full ">
      {/* logo section */}
      ...
      <div className="min-h-[80dvh] mx-auto bg-gray-50 max-w-6xl w-full flex flex-col md:flex-row items-center">
