    ...
    <>
      <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-[var(--orange-box-bg)]">404</p>
          <h1 className="font-semibold font-mono text-3xl tracking-tight text-gray-900 sm:text-5xl">Page not found</h1>
